    ...
    <div style={{ maxWidth: 560 }}>
      <div style={{ marginBottom: 28 }}>
        ...
        <p style={{ color: "var(--muted)", marginTop: 6 }}>
          Heads or tails — 1.96× payout on a win. House edge: 2%.
        </p>
      </div>
      ...
      <div className="card">
        <BetPanel onBet={handleBet} maxBet={maxBet} loading={loading}>
          ...
          <div style={{
            ...
            <span className="mono" style={{ color: "var(--blue)" }}>48%</span>
            <span>Payout</span>
            <span className="mono" style={{ color: "var(--green)" }}>1.96×</span>
          </div>
        </BetPanel>
      </div>
